...
const unsplash_access_key = "Y523ekZfcrFFNQKeXpbsPlQhe1zW4vGPwrASfRsfJmo";
const nytimes_api_key = "TTRVejE1bR2Xl32FzwtGa0faAYc3EAGH";
...
function addImage(images) {
  ...
  if (images && images.results && images.results[0]) {
    ...
    htmlContent =
      '<div class="error-no-image">Unfortunately, no image was returned for your search.</div>';
  }
