(function (window) {
  ...
  var functionBody = allOfSubmitOnclick.slice(
    allOfSubmitOnclick.indexOf("{") + 1,
    allOfSubmitOnclick.lastIndexOf("}")
  );
    ...
    grader.addTest(
      function () {
        window.dispatchEvent(
          new CustomEvent("ud-onsubmit", { detail: "passed" })
        );
        return true;
      },
      {
  ...
  var incorrectPasswords = [
    ...
    {
      pw:
        "CBAABCCBAABCCBAABCCBAABCCBAABCCBAABCCBAABCCBAABCCBAABCCBAABCCBAABCCBAABCCBAABCCBAABCCBAABCCBAABCCBAABCCBAABCCBAABCC1!",
      expected: ["lowercase", "100"],
    },
    {
      pw: "password1",
      expected: ["16", "uppercase", "symbol"],
    },
    {
  ...
  grader.addTest(
    function () {
      ...
      correctPasswords.forEach(function (pw, index) {
        ...
        if (
          (firstStudentMessage && firstStudentMessage.match(re)) ||
          (secondStudentMessage && secondStudentMessage.match(re))
        ) {
      ...
      if (allPass) {
        window.dispatchEvent(
          new CustomEvent("ud-matching", { detail: "passed" })
        );
      }
      return allPass;
    },
  ...
  grader.addTest(
    function () {
      ...
      if (allHaveMessage) {
        window.dispatchEvent(
          new CustomEvent("ud-symbol", { detail: "passed" })
        );
      }
      return allHaveMessage;
    },
  ...
  grader.addTest(
    function () {
      ...
      if (allHaveMessage) {
        window.dispatchEvent(
          new CustomEvent("ud-number", { detail: "passed" })
        );
      }
      return allHaveMessage;
    },
  ...
  grader.addTest(
    function () {
      ...
      if (allHaveMessage) {
        window.dispatchEvent(
          new CustomEvent("ud-lowercase", { detail: "passed" })
        );
      }
      return allHaveMessage;
    },
  ...
  grader.addTest(
    function () {
      ...
      if (allHaveMessage) {
        window.dispatchEvent(
          new CustomEvent("ud-uppercase", { detail: "passed" })
        );
      }
      return allHaveMessage;
    },
  ...
  grader.addTest(
    function () {
      ...
      if (allHaveMessage) {
        window.dispatchEvent(
          new CustomEvent("ud-illegal", { detail: "passed" })
        );
      }
      return allHaveMessage;
    },
  ...
  grader.addTest(
    function () {
      ...
      if (hasAllMessages) {
        window.dispatchEvent(
          new CustomEvent("ud-incorrect", { detail: "passed" })
        );
      }
  ...
  grader.addTest(
    function () {
      ...
      if (allPass) {
        window.dispatchEvent(
          new CustomEvent("ud-correct", { detail: "passed" })
        );
      }
      return allPass;
    },
